...
curl -o .github/workflows/gemini-triage.yml https://raw.githubusercontent.com/MillionthOdin16/run-gemini-cli/main/examples/workflows/issue-triage/gemini-triage.yml
curl -o .github/workflows/gemini-scheduled-triage.yml https://raw.githubusercontent.com/MillionthOdin16/run-gemini-cli/main/examples/workflows/issue-triage/gemini-scheduled-triage.yml
```
