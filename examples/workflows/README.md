...
This directory contains a collection of example workflows that demonstrate how to use the [Gemini CLI GitHub Action](https://github.com/MillionthOdin16/run-gemini-cli). These workflows are designed to be reusable and customizable for your own projects.
